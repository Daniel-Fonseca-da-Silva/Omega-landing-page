    ...
    <section className="w-full mx-auto py-10 mdl:py-24 flex flex-col items-center gap-4 lgl:gap-8 mdl:px-10 xl:px-4 mt-10 border border-y-btnColor1 border-x-transparent bg-darkBanner">
      <div className="w-10/12 -mb-10 -mt-10">
        <div className="flex flex-col md:flex-row justify-center">
          ...
          <div className="mx-auto md:w-2/4">
            <h2 className="font-titleFont xs:text-center xs:text-xl sm:text-xl md:text-xl  md:text-start lg:text-5xl font-semibold">
              ¡Estás seguro al 100%!
            </h2>
            <p className="text-base xs:text-center xs:text-base sm:text-base md:text-base md:text-start font-bodyFont tracking-wide py-6">

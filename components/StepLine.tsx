...
const StepLine = () => {
  return (
    <section className="w-full mx-auto py-10 mdl:py-24 flex flex-col items-center gap-4 lgl:gap-8 mdl:px-10 xl:px-4">
      ...
      >
        <h2 className="xx:text-sm lg:text-4xl md:text-4xl xm:pt-5 sm:pt-5 font-titleFont font-bold tracking-wide text-center uppercase xs:mt-5 text-textDark pb-10">
        ...
        <ol className="relative border-l px-10 py-10 border-colorBaseOne shadow-md shadow-colorBaseOne PX bg-gray-100">
          <li className="mb-10 border border-colorBaseOne shadow-md shadow-colorBaseOne px-2 py-2 rounded-md">
            ...
            <h3 className="mb-1 xx:text-xs xx:text-center xs:text-left xs:text-base sm:text-base md:text-lg lg:text-xl text-sm leading-none text-colorBaseTwo font-medium uppercase font-titleSecondFont">
            ...
            <p className="mb-4 xx:text-xs xx:text-center xs:text-left xs:text-sm sm:text-sm md:text-base lg:text-lg text-base font-normal text-textDark">
          ...
          <li className="mb-10 border border-colorBaseOne shadow-md shadow-colorBaseOne px-2 py-2 rounded-md">
            ...
            <p className="mb-10 xx:text-xs xx:text-center xs:text-left xs:text-sm sm:text-sm md:text-base lg:text-lg text-base font-normal text-textDark">
          ...
          <li className="mb-10 border border-colorBaseOne shadow-md shadow-colorBaseOne px-2 py-2 rounded-md">
            <div className="absolute w-3 h-3 bg-colorBaseOne rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
            <h3 className="mb-1 xx:text-xs xx:text-center xs:text-left xs:text-base sm:text-base md:text-lg lg:text-xl text-sm leading-none font-medium text-colorBaseTwo uppercase font-titleSecondFont">
              <span className="bg-gradient-to-r from-colorBaseOne to-colorBaseTwo text-transparent bg-clip-text text-center">
                9ª Beneficio:
              </span>{" "}
